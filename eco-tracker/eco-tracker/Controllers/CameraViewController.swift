...
//    animateFocusView()
  ...
  private func setupSessionOutput() {
    ...
    let output2 = AVCaptureVideoDataOutput()
    output2.videoSettings = [kCVPixelBufferPixelFormatTypeKey as String: Int(kCVPixelFormatType_32BGRA)]
    output2.setSampleBufferDelegate(self, queue: DispatchQueue.global(qos: DispatchQoS.QoSClass.default))
    
    captureSession.addOutput(output2)
