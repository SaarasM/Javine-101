...
packaging_arr = np.array([plastic_co2_per_kg, recycled_paper_co2_per_kg, cardboard_co2_per_kg, glass_co2_per_kg])
print(packaging_arr)
...
oreo_ingredients = [primary_ingridient, secondary_ingredient, tertiary_ingredient]
print(oreo["product"]["product_name"])
grade = oreo["product"]["nutrition_grades"]
packaging = oreo["product"]["packaging"]
product_score = (primary_ingridient * 5 + secondary_ingredient * 3 + tertiary_ingredient * 2)
